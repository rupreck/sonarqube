...
public class SourceLineIndexDefinition implements IndexDefinition {
  ...
  public void define(IndexDefinitionContext context) {
    ...
    mapping.stringFieldBuilder(FIELD_SCM_REVISION).docValues().disableSearch().build();
    mapping.stringFieldBuilder(FIELD_SCM_AUTHOR).docValues().disableSearch().build();
    mapping.createDateTimeField(FIELD_SCM_DATE);
    mapping.stringFieldBuilder(FIELD_HIGHLIGHTING).docValues().disableSearch().build();
    mapping.stringFieldBuilder(FIELD_SOURCE).docValues().disableSearch().build();
    ...
    mapping.stringFieldBuilder(FIELD_SYMBOLS).docValues().disableSearch().build();
